...
获取 index 列表：
    ...
    curl -u username:password http://xxxxxx:9200/_cat/indices

查看 index 结构：

    curl -u username:password http://xxxxxx:9200/{index}/_mapping?pretty=true

查看 index 数据：

    curl -u username:password http://xxxxxx:9200/{index}/_search?pretty=true
